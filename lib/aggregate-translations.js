...
const aggregatedTranslations = (options) => {
  ...
  writeAggregatedTranslations(aggregatedMessages, locales, fileSystem, outputDirectory, !intlShape);

  /**
   * Detecting react-intl version used. `react-intl` v3 and greater does not export the intlShape.
   * In order to use these versions of `react-intl` consumers should utilize terra-application v2, which provides these loaders.
   */
  if (intlShape !== undefined) {
